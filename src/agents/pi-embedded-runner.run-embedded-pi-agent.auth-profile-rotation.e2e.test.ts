  ...
  ({
    ...
    models: {
      providers: {
        openai: {
          api: "openai-responses",
          apiKey: opts?.apiKey ?? "your-api-key-here",
  ...
  const payload = {
    ...
    profiles: {
      ...
      ...(opts?.includeAnthropic
        ? { "anthropic:default": { type: "api_key", provider: "anthropic", key: "your-api-key-here" } }
        : {}),
    },
    usageStats:
      opts?.usageStats ??
      ...
      try {
        ...
        const payload = {
          ...
          profiles: {
            "openai:p1": { type: "api_key", provider: "openai", key: "sk-one" },
            "openai:p2": { type: "api_key", provider: "openai", key: "sk-two" },
            "openai:p3": { type: "api_key", provider: "openai", key: "your-api-key-here" },
          },
          usageStats: {
            "openai:p1": { lastUsed: 1 },
