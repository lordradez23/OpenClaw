...
describe("fetchWithSlackAuth", () => {
  ...
  it("sends Authorization header on initial request with manual redirect", async () => {
    ...
    const result = await fetchWithSlackAuth("https://files.slack.com/test.jpg", "xoxb-your-slack-token");
  ...
  it("rejects non-Slack hosts to avoid leaking tokens", async () => {
    await expect(
      fetchWithSlackAuth("https://example.com/test.jpg", "xoxb-your-slack-token"),
  ...
  it("handles relative redirect URLs", async () => {
    ...
    await fetchWithSlackAuth("https://files.slack.com/original.jpg", "xoxb-your-slack-token");
  ...
  it("handles 301 permanent redirects", async () => {
    ...
    await fetchWithSlackAuth("https://files.slack.com/test.jpg", "xoxb-your-slack-token");
