...
| **Control UI** | [Lit](https://lit.dev/), [Vite](https://vitejs.dev/), Vanilla CSS |
| **Gateway (API)** | [Express](https://expressjs.com/), [WebSockets](https://github.com/websockets/ws), [TypeBox](https://github.com/sinclairzx81/typebox), [Zod](https://zod.dev/) |
| **Messaging** | [Baileys](https://github.com/WhiskeySockets/Baileys) (WhatsApp), [grammY](https://grammy.dev/) (Telegram), [Bolt](https://slack.dev/bolt-js/) (Slack), [discord.js](https://discord.js.org/) (Discord) |
| **Data & Storage** | [SQLite](https://www.sqlite.org/), [sqlite-vec](https://github.com/asg017/sqlite-vec) |
| **Automation & Tools** | [Croner](https://github.com/hexon/croner), [Playwright](https://playwright.dev/), [ElevenLabs](https://elevenlabs.io/) (Voice) |
| **Quality Assurance** | [Vitest](https://vitest.dev/), [oxlint](https://oxlint.dev/), [oxfmt](https://github.com/oxc-project/oxc) |
| **Mobile & Native** | [Swift](https://developer.apple.com/swift/) (macOS/iOS), Java/Gradle (Android) |
