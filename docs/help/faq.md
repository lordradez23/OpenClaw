...
- [Quick start and first-run setup]
  ...
  - [Can I ask OpenClaw to update itself?](#can-i-ayour-api-key-here)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtayour-api-key-here)
